package com.diplom.app.fitnessproject.view.library;
...
public class CircleStopWatchView extends View
{
    ...
    public CircleStopWatchView(Context context, AttributeSet attrs, int defStyleAttr)
    {
        super(context, attrs, defStyleAttr);
        initialize();
    }

    public CircleStopWatchView(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public CircleStopWatchView(Context context)
    {
        this(context, null);
    }
